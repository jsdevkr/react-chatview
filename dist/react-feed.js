(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Feed = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (global){
...
var Feed = React.createClass({displayName: "Feed",
  ...
  render:function () {
    ...
    return (
      React.createElement("div", {className: this.props.className, ref: "scrollable", 
           style: {overflowX: 'hidden', overflowY: 'scroll'}}, 
        React.createElement("div", {ref: "smoothScrollingWrapper"}, 
  ...
  pollScroll:function () {
    ...
    if (domNode.scrollTop !== this.scrollTop) {
      if (this.shouldTriggerLoad(domNode)) {
        ...
        p.then(function()  {return this.setState({ isInfiniteLoading: false });}.bind(this));
      }
  ...
  isPassedThreshold:function (flipped, scrollLoadThreshold, scrollTop, scrollHeight, clientHeight) {
    return flipped
        ? scrollTop <= scrollLoadThreshold
        : scrollTop >= (scrollHeight - clientHeight - scrollLoadThreshold);
  },

  shouldTriggerLoad:function (domNode) {
...
},{"lodash.clone":11,"react":undefined}],2:[function(require,module,exports){
/**
...
},{"lodash._basecopy":6,"lodash.keys":14}],5:[function(require,module,exports){
(function (global){
/**
...
},{"lodash._arraycopy":2,"lodash._arrayeach":3,"lodash._baseassign":4,"lodash._basefor":7,"lodash.isarray":13,"lodash.keys":14}],6:[function(require,module,exports){
/**
...
},{"lodash._baseclone":5,"lodash._bindcallback":8,"lodash._isiterateecall":10}],12:[function(require,module,exports){
/**
...
},{"lodash._getnative":9,"lodash.isarguments":12,"lodash.isarray":13}]},{},[1])(1)
});